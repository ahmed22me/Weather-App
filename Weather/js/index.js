async function search(a) {
    let t = await fetch(
        ...
        `https://api.weatherapi.com/v1/forecast.json?key=3c0b195ad3ae4229aec95628241406&q=${a}&days=3`
    );
...
function displayCurrent(a, t) {
    if (null != t) {
        ...
        <span><img src="images/umberella.png" alt="">20%</span>\n\t\t\t\t\t\t\t\t<span><img src="images/wind.png" alt="">18km/h</span>\n\t\t\t\t\t\t\t\t<span><img src="images/compass.png" alt="">East</span>\n    </div>\n</div>`;
